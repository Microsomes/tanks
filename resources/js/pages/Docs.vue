...
const stagingCmds = [
    ...
    { cmd: 'terraform apply -var="do_token=..."', desc: 'Provision droplet' },
    { cmd: 'terraform output droplet_ip', desc: 'Get server IP' },
    { cmd: 'cd .infra/staging/ansible && ansible-playbook playbook.yml', desc: 'Configure server' },
...
<span class="text-emerald-400">$</span> open <span class="text-amber-300">http://localhost:9005</span></pre>
                        ...
                        <section id="terraform">
                            ...
                            <p class="mt-2 text-zinc-400">Provisions a DigitalOcean droplet and generates Ansible inventory.</p>
                        ...
                        <section id="ansible">
                            ...
                            <p class="mt-2 text-zinc-400">
                                Configures the droplet after Terraform creates it. Installs Docker, firewall, app directory.
                            </p>
...
<span class="text-violet-400">.infra/staging/</span>
  ...
  <span class="text-violet-400">ansible/</span>
    playbook.yml                       <span class="text-zinc-600"># Docker + UFW + app dir</span>
